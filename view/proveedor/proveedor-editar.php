<h1 class="page-header">
    <?php echo $prove->numero_documento_proveedor != null ? $prove->nombre : 'Nuevo Registro'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=proveedor">Proveedor</a></li>
  <li class="active"><?php echo $prove->numero_documento_proveedor != null ? $prove->nombre : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-proveedor" action="?c=proveedor&a=Editar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="numero_documento_proveedor" value="<?php echo $prove->numero_documento_proveedor; ?>" />
