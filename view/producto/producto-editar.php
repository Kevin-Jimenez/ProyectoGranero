<h1 class="page-header">
    <?php echo $pro->codigo_producto != null ? $pro->nombre : 'Nuevo Registro'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=producto">Producto</a></li>
  <li class="active"><?php echo $pro->codigo_producto != null ? $pro->nombre : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-producto" action="?c=producto&a=Editar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="codigo_producto" value="<?php echo $pro->codigo_producto; ?>" />
